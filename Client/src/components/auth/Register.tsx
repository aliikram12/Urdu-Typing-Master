...
export const Register: React.FC<RegisterProps> = ({ onRegisterSuccess, onSwitchToLogin }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute -top-24 -right-24 w-48 h-48 bg-[#2563EB]/15 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute -bottom-24 -left-24 w-48 h-48 bg-[#38BDF8]/10 rounded-full blur-3xl pointer-events-none" />
      ...
      <form onSubmit={handleSubmit} className="space-y-5 relative z-10">
        ...
        <div>
          <label className="block text-xs font-bold text-[#94A3B8] uppercase tracking-wider mb-2">
            Password <span className="text-[#64748B] font-normal lowercase">(min 6 characters)</span>
          </label>
          <div className="relative">
            <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-[#64748B]">
      ...
      <div className="mt-8 pt-6 border-t border-white/[0.07] text-center relative z-10">
        <p className="text-xs text-[#94A3B8]">
          ...
          <button
            ...
            className="text-[#38BDF8] hover:underline font-bold transition cursor-pointer"
          >
            Log in here
          </button>
        </p>
